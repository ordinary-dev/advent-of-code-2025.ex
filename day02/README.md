...
to add a whole bunch of invalid product IDs to their gift shop database!
...
for any ID which is made only of some sequence of digits repeated twice. So, 55 (5 twice), 6464 (64 twice),
